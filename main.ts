...
const blurSlider = document.getElementById("blurAmount") as HTMLInputElement;
const thresholdSlider = document.getElementById(
  "threshold"
) as HTMLInputElement;
const blurValueDisplay = document.getElementById(
  "blurValue"
) as HTMLSpanElement;
const thresholdValueDisplay = document.getElementById(
  "thresholdValue"
) as HTMLSpanElement;
...
if (blurSlider && thresholdSlider) {
  ...
  thresholdSlider.addEventListener("input", (e) => {
    threshold = parseInt((e.target as HTMLInputElement).value);
