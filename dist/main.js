...
const startEvolution = () => {
    ...
    console.log(`Using ${useOffscreenCanvas ? "OffscreenCanvas" : "regular canvas"} for fitness calculations`);
    const algo = new GeneticAlgorithm(100, // Increased population size
    0.01, bwCtx.getImageData(0, 0, img === null || img === void 0 ? void 0 : img.width, img === null || img === void 0 ? void 0 : img.height), ctx);
